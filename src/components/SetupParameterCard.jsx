...
export default function SetupParameterCard({ param }) {
            ...
            <div className="px-4 pb-4 space-y-4">
              ...
              <div className="bg-secondary rounded-lg p-3">
                ...
                <div className="h-1.5 bg-muted rounded-full relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-muted to-primary rounded-full" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="rounded-lg bg-blue-500/10 border border-blue-500/20 p-3">
                  <div className="text-xs font-medium text-blue-400 mb-1">← Effect</div>
                  <p className="text-xs text-muted-foreground leading-relaxed">{param.leftEffect}</p>
                </div>
                <div className="rounded-lg bg-primary/10 border border-primary/20 p-3">
                  <div className="text-xs font-medium text-primary mb-1">Effect →</div>
