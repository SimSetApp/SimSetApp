...
function wRpmGear(d,w,h,T,u){
  ...
  let s='';for(let i=0;i<segs;i++){const f=i/segs,lit=rpmPct>=f+1/segs*0.5,col=f<0.6?T.ledGreen:f<0.85?T.ledYellow:T.ledRed,on=lit&&(!shift||flash);s+='<div style="flex:1;border-radius:2px;'+(on?'background:radial-gradient(circle,'+col+' 0%,'+col+' 65%,'+col+'88 100%);box-shadow:0 0 3px '+col+',0 0 6px '+col+'aa,0 0 12px '+col+'44,inset 0 0 2px rgba(255,255,255,0.7);opacity:1':'background:rgba(255,255,255,0.04);box-shadow:inset 0 0 3px rgba(0,0,0,0.5),inset 0 1px 1px rgba(0,0,0,0.3);opacity:0.35')+'"></div>';}
...
function wRpmBar(d,w,h,T){
  ...
  for(let i=0;i<segs;i++){const f=i/segs,lit=rpmPct>=f+1/segs*0.5,col=f<0.6?T.ledGreen:f<0.85?T.ledYellow:T.ledRed,on=lit&&(!shift||flash);s+='<div style="flex:1;border-radius:9999px;height:78%;'+(on?'background:radial-gradient(circle,'+col+' 0%,'+col+' 65%,'+col+'88 100%);box-shadow:0 0 3px '+col+',0 0 6px '+col+'aa,0 0 12px '+col+'44,inset 0 0 2px rgba(255,255,255,0.7);opacity:1':'background:rgba(255,255,255,0.04);box-shadow:inset 0 0 3px rgba(0,0,0,0.5),inset 0 1px 1px rgba(0,0,0,0.3);opacity:0.35')+'"></div>';}
